public class Car extends Vehicle {
    ...
    byte num_of_seats, num_of_cylinders;
    ...
    public Car()
    {
        ...
        this.fuel_type = null;
        num_of_cylinders = (byte)0;
        num_of_seats = (byte)0;
    }


    public Car(String body_style, String engine_config, String fuel_type, byte num_of_seats, byte num_of_cylinders) {
        super();
